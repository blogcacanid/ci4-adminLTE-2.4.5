        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header">
                    ...
                    <h3 class="box-title"><?= ucwords($title); ?></h3>

                    <div class="box-tools pull-right">
                        <a href="<?php echo base_url($request->uri->getSegment(1));?>" type="button" class="btn btn-box-tool"><i class="fa fa-refresh"></i></a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    ...
                    <header>
                        <div class="heroe">
                            <span class="logo"><a href="https://codeigniter.com" target="_blank"><img height="44" title="CodeIgniter Logo"
